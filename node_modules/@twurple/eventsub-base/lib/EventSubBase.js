...
const EventSubAutoModMessageHoldV2Subscription_1 = require("./subscriptions/EventSubAutoModMessageHoldV2Subscription");
const EventSubAutoModMessageUpdateV2Subscription_1 = require("./subscriptions/EventSubAutoModMessageUpdateV2Subscription");
...
const EventSubChannelSharedChatSessionBeginSubscription_1 = require("./subscriptions/EventSubChannelSharedChatSessionBeginSubscription");
const EventSubChannelSharedChatSessionUpdateSubscription_1 = require("./subscriptions/EventSubChannelSharedChatSessionUpdateSubscription");
const EventSubChannelSharedChatSessionEndSubscription_1 = require("./subscriptions/EventSubChannelSharedChatSessionEndSubscription");
...
let EventSubBase = class EventSubBase extends typed_event_emitter_1.EventEmitter {
    ...
    onAutoModMessageHoldV2(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubAutoModMessageHoldV2Subscription_1.EventSubAutoModMessageHoldV2Subscription, handler, this, broadcasterId, moderatorId);
    }
    /**
    ...
    onAutoModMessageUpdateV2(broadcaster, moderator, handler) {
        ...
        return this._genericSubscribe(EventSubAutoModMessageUpdateV2Subscription_1.EventSubAutoModMessageUpdateV2Subscription, handler, this, broadcasterId, moderatorId);
    }
    /**
     ...
     */
    onChannelSharedChatSessionBegin(broadcaster, handler) {
        const broadcasterId = this._extractUserIdWithNumericWarning(broadcaster, 'onChannelSharedChatSessionBegin');
        return this._genericSubscribe(EventSubChannelSharedChatSessionBeginSubscription_1.EventSubChannelSharedChatSessionBeginSubscription, handler, this, broadcasterId);
    }
    /**
     ...
     * @param handler The function to be called when a new notification is received.
     */
    onChannelSharedChatSessionUpdate(broadcaster, handler) {
        const broadcasterId = this._extractUserIdWithNumericWarning(broadcaster, 'onChannelSharedChatSessionUpdate');
        return this._genericSubscribe(EventSubChannelSharedChatSessionUpdateSubscription_1.EventSubChannelSharedChatSessionUpdateSubscription, handler, this, broadcasterId);
    }
    /**
     ...
     * @param handler The function to be called when a new notification is received.
     */
    onChannelSharedChatSessionEnd(broadcaster, handler) {
        const broadcasterId = this._extractUserIdWithNumericWarning(broadcaster, 'onChannelSharedChatSessionBegin');
        return this._genericSubscribe(EventSubChannelSharedChatSessionEndSubscription_1.EventSubChannelSharedChatSessionEndSubscription, handler, this, broadcasterId);
    }
    /**
