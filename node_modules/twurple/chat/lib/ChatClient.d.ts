...
export declare class ChatClient extends IrcClient {
     ...
     */
    readonly onTimeout: EventBinder<[channel: string, user: string, duration: number]>;
    /**
     ...
     */
    readonly onBan: EventBinder<[channel: string, user: string]>;
    /**
     ...
     */
    readonly onChatClear: EventBinder<[channel: string]>;
    /**
     ...
     */
    readonly onHost: EventBinder<[channel: string, target: string, viewers?: number]>;
    /**
     ...
     */
    readonly onHostsRemaining: EventBinder<[channel: string, numberOfHosts: number]>;
    /**
     ...
     */
    readonly onUnhost: EventBinder<[channel: string]>;
    /**
     ...
     * @param msg The full message object containing all message and user information.
     */
    readonly onWhisper: EventBinder<[user: string, message: string, msg: Whisper]>;
    /**
     ...
     * @param message The message text.
     */
    readonly onNoPermission: EventBinder<[channel: string, message: string]>;
    /**
     ...
     * @param message The message text.
     */
    readonly onMessageRatelimit: EventBinder<[channel: string, message: string]>;
    /**
     ...
     * @param message The message text.
     */
    readonly onAuthenticationFailure: EventBinder<[message: string]>;
    /**
    ...
    /** @private */
    readonly onPrivmsg: EventBinder<[
        channel: string,
        user: string,
        message: string,
     ...
     * @param msg The full message object containing all message and user information.
     */
    readonly onAction: EventBinder<[channel: string, user: string, message: string, msg: TwitchPrivateMessage]>;
